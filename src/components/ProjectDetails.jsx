    ...
    return (
        <div className="p-8 mt-20 bg-gray-900 text-white min-h-screen">
            ...
            <div className="max-w-4xl mx-auto mt-6 space-y-6 bg-gray-800 p-6 rounded-lg shadow-xl">
                <p><strong className='text-rose-600 text-lg'>Tech Stack:</strong> {project.techStack}</p>
                <p><strong  className='text-rose-600 text-lg'>Description:</strong> {project.description}</p>
                <p><strong  className='text-rose-600 text-lg'>Challenges:</strong> {project.challenges}</p>
                <p><strong  className='text-rose-600 text-lg'>Future Improvements:</strong> {project.improvements}</p>
